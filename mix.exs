defmodule Verdant.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind verdant", "esbuild verdant"],
      "assets.deploy": [
        "tailwind verdant --minify",
        "esbuild verdant --minify",
        "phx.digest"
      ],
