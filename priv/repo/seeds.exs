...
zones = [
  %{
    name: "Back Yard Upper",
    description: "Houseside back yard",
    gpio_pin: 3,
    position: 1,
    enabled: true,
    water_heads: 0,
  ...
  %{
    name: "Back Yard Lower",
    description: "Fenceside back yard",
    gpio_pin: 4,
    position: 2,
    enabled: true,
    water_heads: 0,
  ...
  %{
    name: "Front Yard Doorside",
    description: "Front yard door and mound",
    gpio_pin: 5,
    position: 3,
    enabled: true,
    water_heads: 0,
  ...
  %{
    name: "Front Yard Mound",
    description: "Neighbor-side front yard",
    gpio_pin: 6,
    position: 4,
    enabled: true,
    water_heads: 0,
  ...
  %{
    name: "Front Yard Southside",
    description: "South side front yard",
    gpio_pin: 7,
    position: 5,
    enabled: true,
    water_heads: 0,
  ...
  %{
    name: "Front-North & Grapes",
    description: "North front yard and grapes",
    gpio_pin: 9,
    position: 7,
    enabled: true,
    water_heads: 0,
